...
export default function EditAccessoryModal({ open, accessory, onClose }: EditAccessoryModalProps) {
 ...
 <Button onClick={handleSubmit} className="bg-[var(--brand)] hover:brightness-90 text-[var(--bg-app)] rounded-xl h-12 px-10 text-[11px] font-medium transition-all active:scale-95">
 Save Changes
 </Button>
 </div>
 </div>
